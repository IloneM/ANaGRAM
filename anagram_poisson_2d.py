...
if __name__ == "__main__":
    ...
    # pp: parsed_params
    pp, layer_sizes, seed = Parser.parse(
        args, layer_sizes, seed, model, functional_operators
    )
...
nat_grad = quadratic_nat_grad_factory(
    model, functional_operators, (null_source, f), rcond
)
